...
export const backgroundWallpaper: BackgroundWallpaperConfig = {
	...
	src: {
		...
		desktop: [
			"assets/images/DesktopWallpaper/date1.jpg",
		...
		mobile: [
			"assets/images/MobileWallpaper/alive1.jpg",
			"assets/images/MobileWallpaper/alive2.jpg",
			"assets/images/MobileWallpaper/alive3.jpg",
			"assets/images/MobileWallpaper/alive4.jpg",
	...
	common: {
		...
		homeText: {
			...
			subtitle: [
				...
				"「私の名前……？」",
				"「そんなものは無い。私に名前など無い。」",
				"「世界が私を否定するのだから、名前など、最初から必要無いではないか……」",
				"「——お前は、私の存在を否定しないのか？」",
